...
\end{align}
The first two terms train thought and display diffusion; the others train intent exposure, binding, event-conditioned revision, refresh behavior, symbolic grounding, and the equilibrium signal.
