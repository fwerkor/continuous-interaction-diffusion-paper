...
Table~\ref{tab:cid-mechanisms} maps the six design requirements in Section~2.6 to the CID mechanisms that realize them and restates the intended effect of each design.
