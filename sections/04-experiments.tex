...
The final model is trained in two stages. Stage A freezes the iLLaDA backbone and learns CID-specific channel projections, external-perception fusion, and prediction heads. Stage B then unfreezes the backbone and continues optimization under the same corrected train--runtime contract. The final checkpoint used for evaluation is fixed before benchmark results are collected.
