...
The diagnostic prototype and corrected retraining draw from the released \texttt{fwerkor/CID-Dataset} semantic mixture~\cite{cao2026ciddataset}; the corrected run changes tensorization and train--runtime contracts rather than the underlying semantic examples. The materialized JSONL is
