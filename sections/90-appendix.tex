...
\begin{table*}[t]
  \centering
  \caption{CID-Dataset components used for CID training. ``Tasks'' are semantic tasks before schedule expansion; ``Traj.'' are materialized trajectories; ``Train trans.'' includes each component's bootstrap transitions. Weight is the semantic component multiplier applied after per-task balancing.}
