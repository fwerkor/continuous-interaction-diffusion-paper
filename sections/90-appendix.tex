...
The diagnostic prototype and corrected retraining draw from the released \texttt{fwerkor/CID-Dataset} semantic mixture~\cite{cao2026ciddataset}; the corrected run keeps the underlying semantic examples fixed while changing tensorization and train--runtime contracts. The materialized JSONL is
